...
namespace BackendBase\Shared\Attributes;
...
class Deprecated
{
    public const BACKENDBASE_VERSIONS = ['1.0'];

    /**
     * Mark element as deprecated
     *
     * @param string|null $reason      Reason for deprecation. It will be displayed by PhpStorm via the Deprecated inspection instead of the  default message
     * @param string|null $replacement Applicable only to function/method calls: IDE will suggest replacing a deprecated function call with the provided code template.
     ...
     * @param string|null $since       Element is deprecated starting with the provided PHP language level, applicable only for PhpStorm stubs entries
     */
    public function __construct(
        string |null $reason = '',
        string |null $replacement = '',
        #[ExpectedValues(self::BACKENDBASE_VERSIONS)] string |null $since = '1.0'
    ) {
    }
}
